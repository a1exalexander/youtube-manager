...
export const CATALOG_SEARCH_SET = 'catalog/SEARCH_SET';
...
export const CATALOG_SORT_SET = 'catalog/SORT_SET';

export const FOLDERS_REQUEST = 'folders/FOLDERS_REQUEST';
export const FOLDERS_SET = 'folders/FOLDERS_SET';
export const FOLDERS_ADD = 'folders/FOLDERS_ADD';
export const FOLDERS_UPDATE = 'folders/FOLDERS_UPDATE';
export const FOLDERS_EDIT = 'folders/FOLDERS_EDIT';
export const FOLDERS_REMOVE = 'folders/FOLDERS_REMOVE';
export const FOLDERS_SELECT_ALL = 'folders/FOLDERS_SELECT_ALL';
export const FOLDERS_SELECT = 'folders/FOLDERS_SELECT';
export const FOLDERS_SORTED_SET = 'folders/FOLDERS_SORTED_SET';
export const FOLDERS_VIDEO_COPY = 'folders/FOLDERS_VIDEO_COPY';
export const FOLDERS_VIDEO_REMOVE = 'folders/FOLDERS_VIDEO_REMOVE';
export const FOLDERS_CLEAN = 'folders/FOLDERS_CLEAN';
